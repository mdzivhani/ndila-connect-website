          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Enterprise DevOps & Cloud Solutions
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  Ndila Connect Services helps enterprises design, build, and operate
                  reliable, scalable cloud infrastructure and DevOps platforms that drive
